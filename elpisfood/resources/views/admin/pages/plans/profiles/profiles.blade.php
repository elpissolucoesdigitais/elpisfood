...
@section('content_header')
    ...
    <a href="{{route('plans.profiles.available',$plan->id)}}" class="btn btn-dark">ADD Novo Perfil <i class="fas fa-plus-circle"></i></a></h1>
                    ...
                    @foreach ($profiles as $profile)
                        <tr>
                            ...
                            <td styled="width=10px;">
                                <a href="{{route('plans.profile.detach',[$profile->id, $profile->id])}}" class="btn btn-danger"><i class="fas fa-trash-alt"></i></a>
                            </td>
                        </tr>
                    @endforeach
                </tbody>
